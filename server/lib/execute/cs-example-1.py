...
#list of arg: filename, trise, tfall, tdelay, tw, Vm, tfly, Z0, Zs, Zl
#length of arg: 10
...
if (length_argv != 11):
    print "Error. Losslesstl computing need 10 arguments."
    print "Order of arguments: filename, trise, tfall, tdelay, tw, Vm, tfly, Z0, Zs, Zl, trun"

else:
    #read arguments from command lines
    arg_compute_list = ele_argv[1 : length_argv]

    #convert arguments to float
    [trise, tfall, tdelay, twidth, Vm, tfly, Z0, Zs, Zl, trun] = map(float, arg_compute_list)
